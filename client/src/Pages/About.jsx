...
function About() {
  ...
  return (
    <>
    <div><p className='text-4xl font-Montserrat font-semibold p-3 text-center justify-center lg:ml-16 '><span className='text-transparent bg-clip-text bg-gradient-to-l to-blue-300 from-purple-500'>About Us</span></p></div>
    ...
    <div className="relative mx-auto h-full px-4  pb-20   md:pb-10 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            <div className=" relative ">
                <div className=" absolute top-0 -left-36 z-0  opacity-30 ">
